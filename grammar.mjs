...
export const
  raw_string_delimiter = rule(),

  raw_string_content = rule(),
  ...
  _top_level_item = rule(() => choice(
    ...membersOf(C._top_level_item.body()).filter(member => !isOldStyleFunction(member)),
  ...
  _block_item = rule(() => choice(
    ...membersOf(C._block_item.body()).filter(member =>
  ...
  type_qualifier = rule(() => choice(
    C.type_qualifier.body(),
    'mutable',
    'constinit',
    'consteval',
  )),

  type_descriptor = rule(() => prec.right(C.type_descriptor.body())),

  attribute = rule(() => seq(
    optional(seq('using', field('namespace', C.identifier), ':')),
    ...membersOf(C.attribute.body()),
  )),

  annotation = rule(() => seq('=', C.expression)),

  attribute_declaration = rule(() => choice(
    C.attribute_declaration.body(),
  ...
  function_definition = rule(() => ({
    ...
    members: membersOf(C.function_definition.body()).map(
  ...
  _declaration_modifiers = rule(() => choice(
    C._declaration_modifiers.body(),
    'virtual',
  )),
  ...
  storage_class_specifier = rule(() => choice(
    ...membersOf(C.storage_class_specifier.body()).filter(member => !('value' in member && member.value === 'auto')),
    'thread_local',
  )),
  ...
  init_declarator = rule(() => choice(
    C.init_declarator.body(),
    seq(
      field('declarator', _declarator),
      field('value', choice(
        argument_list,
  ...
  //   A b {};
  compound_statement = rule(() => prec(-1, C.compound_statement.body())),
  ...
  _field_declaration_list_item = rule(() => choice(
    C._field_declaration_list_item.body(),
    template_declaration,
  ...
  _field_declarator = rule(() => choice(
    C._field_declarator.body(),
    alias(reference_field_declarator, reference_declarator),
    template_method,
    operator_name,
  )),

  _type_declarator = rule(() => choice(
    C._type_declarator.body(),
    alias(reference_type_declarator, reference_declarator),
  )),

  _abstract_declarator = rule(() => choice(
    C._abstract_declarator.body(),
  ...
  // Statements
  _top_level_statement = rule(() => choice(
    C._top_level_statement.body(),
    co_return_statement,
    co_yield_statement,
    for_range_loop,
    expansion_statement,
  ...
  _non_case_statement = rule(() => choice(
    C._non_case_statement.body(),
    co_return_statement,
    co_yield_statement,
    for_range_loop,
    expansion_statement,
  ...
  _for_statement_body = rule(() => prec.dynamic(1, C._for_statement_body.body())),
  ...
  return_statement = rule(() => seq(
    choice(
      C.return_statement.body(),
  ...
  // Expressions
  _expression_not_binary = rule(() => choice(
    C._expression_not_binary.body(),
    co_await_expression,
    requires_expression,
    requires_clause,
    template_function,
  ...
  call_expression = rule(() => prec.dynamic(1, choice(C.call_expression.body(), seq(
  ...
  sizeof_expression = rule(() => prec.right(PREC.SIZEOF, choice(
    C.sizeof_expression.body(),
    seq(
      'sizeof', '...',
      '(',
  ...
  unary_expression = rule(() => choice(
    C.unary_expression.body(),
  ...
  compound_literal_expression = rule(() => choice(
    C.compound_literal_expression.body(),
    seq(
      field('type', choice(
        _class_name,
        C.primitive_type,
  ...
  _assignment_left_expression = rule(() => choice(
    C._assignment_left_expression.body(),
    qualified_identifier,
    user_defined_literal,
  )),
  ...
  parenthesized_expression = rule(() => choice(
    C.parenthesized_expression.body(),
